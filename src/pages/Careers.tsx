          ...
          <div className="relative max-w-4xl mx-auto px-6 text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              <h1 className="text-4xl lg:text-5xl font-extrabold text-foreground mb-6">
                Build the Future of <span className="text-primary">Recruiting</span>
              </h1>
        ...
        <section className="py-20">
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="space-y-4">
              {positions.length > 0 ? (
                positions.map((pos, i) => (
                  ...
                  >
                    <div>
                      <h3 className="font-bold text-foreground text-lg mb-1 group-hover:text-primary transition-colors">{pos.title}</h3>
                    ...
                    <div className="mt-4 md:mt-0 flex items-center gap-2 text-primary font-semibold text-sm">
                ...
                >
                  ...
                  <a 
                    ...
                    className="inline-flex items-center gap-2 px-8 py-3 rounded-full bg-primary text-primary-foreground font-semibold hover:opacity-90 transition-all shadow-lg shadow-primary/20"
                  >
            ...
            <p className="mt-12 text-center text-muted-foreground text-sm">
              Don't see a role that fits? Send your resume to <a href="mailto:aifunk63@gmail.com" className="text-primary hover:underline">aifunk63@gmail.com</a> and tell us how you can help!
            </p>
          </div>
        </section>
      </main>
