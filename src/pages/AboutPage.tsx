        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <h1 className="text-4xl lg:text-6xl font-extrabold text-foreground leading-tight mb-6">
              We're on a Mission to <span className="text-primary">Fix Hiring</span>
            </h1>
          ...
          <div className="relative">
            ...
            <div className="space-y-8">
              {milestones.map((m, i) => (
                ...
                >
                  <div className="w-11 h-11 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0 relative z-10">
          ...
          <div className="flex justify-center">
            <div className="max-w-md w-full">
              {team.map((person, i) => (
                ...
                >
                  <div className="w-16 h-16 rounded-full bg-primary mx-auto mb-4 flex items-center justify-center text-primary-foreground text-lg font-bold">
                    {person.avatar}
                  </div>
                  <h3 className="font-semibold text-foreground">{person.name}</h3>
                  <p className="text-xs text-primary font-medium mb-3">{person.role}</p>
